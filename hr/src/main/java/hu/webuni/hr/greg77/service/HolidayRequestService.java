...
import hu.webuni.hr.greg77.dto.HolidayRequestFilterDto;
import hu.webuni.hr.greg77.model.Employee;
import hu.webuni.hr.greg77.model.HolidayRequest;
import hu.webuni.hr.greg77.repository.HolidayRequestRepository;
import hu.webuni.hr.greg77.security.HrUser;
...
public class HolidayRequestService {
	...
	public HolidayRequest approveHolidayRequest(long id, boolean status) {
		...
		Employee employeeOfRequest = holidayRequest.getEmployee();
		if(employeeOfRequest.getManager() == null || employeeOfRequest.getManager().getId() != currentEmployee.getId())
	...
	public void deleteHolidayRequest(long id) {
		...
		if(holidayRequest.getEmployee().getId() != currentUser.getEmployee().getId())
