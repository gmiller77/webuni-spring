...
public abstract class AbstractEmployeeService implements EmployeeService {
	...
	{
		employees.put(1L,
				new Employee(1L, "Anna Smith", "chief", 30_000, LocalDateTime.now().minusMonths(130)));
		employees.put(2L,
				new Employee(2L, "Bob Tailor", "assistant", 12_000, LocalDateTime.now().minusMonths(119)));
		employees.put(3L,
		...
		employees.put(5L,
				new Employee(5L, "Eric Tesla", "technician", 8_000, LocalDateTime.now().minusMonths(28)));
	}
