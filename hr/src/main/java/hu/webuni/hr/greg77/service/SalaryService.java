...
public class SalaryService {
	...
	// emeli a fizetését
	// ehhez egy EmplService-t használ, injektál, és ettől kéri el, hogy ?%
	// fizetésemelés jár az alkalmazottnak
	 ...
	 * employee.setSalary((int)(employee.getSalary()*(1.0+employeeService.
	 * getPayRaisePercent(employee))));
	 */
