...
import hu.webuni.hr.greg77.model.Company_;
import hu.webuni.hr.greg77.model.Employee;
import hu.webuni.hr.greg77.model.Employee_;
import hu.webuni.hr.greg77.model.Position_;
...
public class EmployeeSpecifications {
	...
	public static Specification<Employee> hasEntryDate(LocalDateTime entryDate) {
		LocalDateTime startOfEntryDay = LocalDateTime.of(entryDate.toLocalDate(), LocalTime.of(0, 0));
		return (root, cq, cb) -> cb.between(root.get(Employee_.startDate), startOfEntryDay, startOfEntryDay.plusDays(1));
	}
